var a = document.querySelectorAll('.accordion3 div:nth-child(2)');
a[0].style.display='none'
var b = document.querySelectorAll('.accordion3 div:nth-child(1)>div')[0];
...
function clse(){
    document.querySelectorAll('.accordion3 div:nth-child(1)>div>span')[0].style.display="none"
...
async function open(){
    a[0].style.display='none'
    document.querySelectorAll('.accordion3 div:nth-child(1)>div>span')[0].style.display="block"
